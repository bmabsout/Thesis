...
These seemingly disparate challenges stem from the inherent lack of structure in existing reward and value functions. To address this, I introduce fulfillment—reconceptualizing objectives as continuous logical values to fulfill rather than scalar values to maximize. Using generalized means as continuous logic operators, fulfillments enable semantic-preserving composition with gradient-based optimization.
