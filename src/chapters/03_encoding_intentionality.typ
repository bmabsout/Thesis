...
= Encoding Intentionality <chap:encoding_intentionality>
...
#theorem(title: [Semantic Preservation <thm:semantic-preservation>])[
...
#theorem(title: [Minimum Fulfillment Bound <thm:min-fulfillment-bound>])[
